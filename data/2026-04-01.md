...
### [1] [Parallelobox: Improved Decomposition for Optimized Parallel Printing using Axis-Aligned Bounding Boxes](https://arxiv.org/abs/2603.29579)
...
### [2] [See Something, Say Something: Context-Criticality-Aware Mobile Robot Communication for Hazard Mitigations](https://arxiv.org/abs/2603.28901)
...
### [3] [World2Rules: A Neuro-Symbolic Framework for Learning World-Governing Safety Rules for Aviation](https://arxiv.org/abs/2603.28952)
...
### [4] [Industrial-Grade Robust Robot Vision for Screw Detection and Removal under Uneven Conditions](https://arxiv.org/abs/2603.29363)
...
### [5] [Learning Semantic Priorities for Autonomous Target Search](https://arxiv.org/abs/2603.29391)
...
### [6] [CLaD: Planning with Grounded Foresight via Cross-Modal Latent Dynamics](https://arxiv.org/abs/2603.29409)
...
### [7] [CReF: Cross-modal and Recurrent Fusion for Depth-conditioned Humanoid Locomotion](https://arxiv.org/abs/2603.29452)
*Yuan Hao,Ruiqi Yu,Shixin Luo,Guoteng Zhang,Jun Wu,Qiuguo Zhu*

Main category: cs.RO

TL;DR: CReF is a single-stage depth-conditioned humanoid locomotion framework that learns locomotion features directly from raw depth data using cross-modal attention, gated residual fusion, and GRU-based temporal integration, achieving robust traversal on complex terrains including vertical structures, perforated obstacles, and real-world clutter with zero-shot transfer capabilities.


<details>
  <summary>Details</summary>
Motivation: Prior perceptive humanoid locomotion methods rely on explicit geometric abstractions (2.5D terrain representations or geometry-related targets for depth learning), which suffer from representational bias and are restrictive for vertical structures, perforated obstacles, and complex real-world clutter. Stable traversal over geometrically complex terrain increasingly requires exteroceptive perception.

Method: CReF (Cross-modal and Recurrent Fusion) framework with: (1) Proprioception-queried cross-modal attention to couple proprioception and depth tokens; (2) Gated residual fusion block; (3) Gated Recurrent Unit (GRU) with highway-style output gate for temporal integration; (4) Terrain-aware foothold placement reward extracting supportable foothold candidates from foot-end point-cloud samples.

Result: Experiments in simulation and on a physical humanoid demonstrate robust traversal over diverse terrains and effective zero-shot transfer to real-world scenes containing handrails, hollow pallet assemblies, severe reflective interference, and visually cluttered outdoor surroundings.

Conclusion: CReF enables stable humanoid locomotion without explicit geometric intermediates, overcoming representational bias and successfully handling complex real-world environments including vertical structures, perforated obstacles, and cluttered scenes.
...
### [8] [Communication Outage-Resistant UUV State Estimation: A Variational History Distillation Approach](https://arxiv.org/abs/2603.29512)
...
### [9] [GraSP-STL: A Graph-Based Framework for Zero-Shot Signal Temporal Logic Planning via Offline Goal-Conditioned Reinforcement Learning](https://arxiv.org/abs/2603.29533)
...
### [10] [Semantic Zone-Based Map Management for Stable AI-Integrated Mobile Robots](https://arxiv.org/abs/2603.29627)
...
### [11] [Design and Aerodynamic Modeling of MetaMorpher: A Hybrid Rotary andFixed-Wing Morphing UAV](https://arxiv.org/abs/2603.29646)
...
### [12] [SafeDMPs: Integrating Formal Safety with DMPs for Adaptive HRI](https://arxiv.org/abs/2603.29708)
...
### [13] [Reconfiguration of supernumerary robotic limbs for human augmentation](https://arxiv.org/abs/2603.29808)
...
### [14] [DIAL: Decoupling Intent and Action via Latent World Modeling for End-to-End VLA](https://arxiv.org/abs/2603.29844)
...
### [15] [Passive iFIR filters for data-driven velocity control in robotics](https://arxiv.org/abs/2603.29882)
*Yi Zhang,Zixing Wang,Fulvio Forni*

Main category: cs.RO

TL;DR: A passive, data-driven velocity control method for nonlinear robotic manipulators using VRFT-based design with iFIR controllers that achieves better tracking performance than PID while preserving stability guarantees.


<details>
  <summary>Details</summary>
Motivation: To achieve better tracking performance than optimized PID with comparable design complexity, and to bridge learning-based control approaches with stability-guaranteed design by retaining passivity-based guarantees.

Method: Using only three minutes of probing data, a VRFT-based design identifies passive iFIR controllers that preserve closed-loop stability via passivity constraints.

Result: Outperforms a VRFT-tuned PID baseline on the Franka Research 3 robot in both joint-space and Cartesian-space velocity control, achieving up to 74.5% reduction in tracking error for Cartesian velocity tracking. The controller can be re-learned when end-effector dynamics change.

Conclusion: The study successfully demonstrates that passive iFIR controllers can learn from data while retaining passivity-based stability guarantees, bridging the gap between learning-based control and stability-guaranteed design approaches.
...
### [16] [Hybrid Framework for Robotic Manipulation: Integrating Reinforcement Learning and Large Language Models](https://arxiv.org/abs/2603.30022)
*Md Saad,Sajjad Hussain,Mohd Suhaib*

Main category: cs.RO

TL;DR: A hybrid RL-LLM framework that combines low-level control with high-level reasoning to improve robotic manipulation performance, achieving significant improvements in task completion time, accuracy, and adaptability over RL-only systems.


<details>
  <summary>Details</summary>
Motivation: Robotic manipulation tasks require effective integration of low-level control execution with high-level reasoning to understand complex natural language instructions and adapt to changing environments in real time.

Method: A novel hybrid framework that integrates Reinforcement Learning for accurate low-level control with Large Language Models for high-level task planning and natural language understanding, tested in PyBullet simulation with the Franka Emika Panda robotic arm.

Result: The framework achieved a 33.5% decrease in task completion time, 18.1% improvement in accuracy, and 36.4% improvement in adaptability compared to RL-only systems across various manipulation scenarios.

Conclusion: The LLM-enhanced robotic system demonstrates significant potential for practical applications, making robots more efficient, adaptable, and capable of human interaction, with future work focusing on sim-to-real transfer, scalability, and multi-robot systems.
...
### [17] [HapCompass: A Rotational Haptic Device for Contact-Rich Robotic Teleoperation](https://arxiv.org/abs/2603.30042)
*Xiangshan Tan,Jingtian Ji,Tianchong Jiang,Pedro Lopes,Matthew R. Walter*

Main category: cs.RO

TL;DR: HapCompass is a low-cost wearable haptic device that renders 2D directional cues by mechanically rotating a single linear resonant actuator (LRA). It improves teleoperation performance by increasing success rate, reducing completion time and contact force, and enhancing imitation learning data quality compared to vision-only and non-directional feedback baselines.


<details>
  <summary>Details</summary>
Motivation: Contact-rich manipulation presents significant challenges in robotic teleoperation. While haptic feedback is essential for such tasks, intuitive directional cues in wearable interfaces remain a bottleneck. Existing solutions have critical limitations: non-directional vibrations from handheld controllers provide insufficient information, and vibrotactile arrays are prone to perceptual interference.

Method: HapCompass was proposed as a novel, low-cost wearable haptic device that renders 2D directional cues by mechanically rotating a single linear resonant actuator (LRA). The device was evaluated through: (1) teleoperated manipulation tasks comparing against vision-only and non-directional feedback baselines; (2) a preliminary imitation-learning evaluation to assess the quality of demonstration data and policy performance.

Result: HapCompass demonstrated significant improvements: increased success rate, decreased completion time, and reduced maximum contact force in teleoperated manipulation tasks. The directional feedback also enhanced the quality of demonstration data and improved the trained policy in the imitation-learning evaluation.

Conclusion: HapCompass effectively addresses the challenge of conveying intuitive directional cues in wearable teleoperation interfaces. By mechanically rotating a single LRA to render 2D directional feedback, it overcomes the limitations of existing approaches while remaining low-cost. The device benefits both human operators (through improved task performance) and AI systems (through enhanced demonstration data quality), making it a practical solution for contact-rich robotic teleoperation applications. The authors have released the device design and implementation code publicly.
